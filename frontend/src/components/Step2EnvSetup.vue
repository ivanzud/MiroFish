    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ t('step2.instanceInitTitle') }}</span>
          </div>
        ...
        <div class="card-content">
          ...
          <p class="description">
            {{ t('step2.instanceInitDescription') }}
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ t('step2.generateProfilesTitle') }}</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <p class="description">
            {{ t('step2.generateProfilesDescription') }}
          </p>
          ...
          <div v-if="profiles.length > 0" class="profiles-preview">
            <div class="preview-header">
              <span class="preview-title">{{ t('step2.generatedProfilesTitle') }}</span>
            </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ t('step2.generateConfigTitle') }}</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            {{ t('step2.generateConfigDescription') }}
          </p>
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              <div class="config-grid">
                <div class="config-item">
                  ...
                  <span class="config-item-value">{{ t('step2.hoursValue', { value: simulationConfig.time_config?.total_simulation_hours || '-' }) }}</span>
                </div>
                <div class="config-item">
                  <span class="config-item-label">{{ t('step2.minutesPerRound') }}</span>
                  <span class="config-item-value">{{ t('step2.minutesValue', { value: simulationConfig.time_config?.minutes_per_round || '-' }) }}</span>
                </div>
                <div class="config-item">
                  <span class="config-item-label">{{ t('step2.totalRounds') }}</span>
                  <span class="config-item-value">{{ t('step2.roundsValue', { value: Math.floor((simulationConfig.time_config?.total_simulation_hours * 60 / simulationConfig.time_config?.minutes_per_round)) || '-' }) }}</span>
                </div>
                <div class="config-item">
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">{{ t('step2.agentConfigTitle') }}</span>
                <span class="config-block-badge">{{ t('step2.countValue', { value: simulationConfig.agent_configs?.length || 0 }) }}</span>
              </div>
                ...
                >
                  ...
                  <div class="agent-card-header">
                    <div class="agent-identity">
                      <span class="agent-id">{{ t('step2.agentId', { id: agent.agent_id }) }}</span>
                  ...
                  <div class="agent-params">
                    <div class="param-group">
                      ...
                      <div class="param-item">
                        ...
                        <span class="param-value">{{ t('step2.delayRangeMinutes', { min: agent.response_delay_min, max: agent.response_delay_max }) }}</span>
                      </div>
                    </div>
                    <div class="param-group">
                      <div class="param-item">
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">{{ t('step2.recommendationConfigTitle') }}</span>
              </div>
              <div class="platforms-grid">
                <div v-if="simulationConfig.twitter_config" class="platform-card">
                  <div class="platform-card-header">
                    <span class="platform-name">{{ t('step2.platform1Title') }}</span>
                  </div>
                ...
                <div v-if="simulationConfig.reddit_config" class="platform-card">
                  <div class="platform-card-header">
                    <span class="platform-name">{{ t('step2.platform2Title') }}</span>
                  </div>
                  <div class="platform-params">
                    <div class="param-row">
                      <span class="param-label">{{ t('step2.recencyWeight') }}</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ t('step2.initialActivationTitle') }}</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            {{ t('step2.initialActivationDescription') }}
          </p>
                  ...
                  <div class="timeline-content">
                    <div class="post-header">
                      ...
                      <span class="post-agent-info">
                        <span class="post-id">{{ t('step2.agentId', { id: post.poster_agent_id }) }}</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <p class="description">{{ t('step2.readyDescription') }}</p>
          ...
          <div v-if="step3RecoveryState" class="step3-recovery-card">
            ...
            <button
              class="action-btn secondary recovery"
              type="button"
              @click="openSavedStep3Run"
            >
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                <span class="section-title">{{ t('step2.roundConfigTitle') }}</span>
                <span class="section-desc">{{ t('step2.roundConfigDescription', { hours: simulationConfig?.time_config?.total_simulation_hours || '-', minutes: simulationConfig?.time_config?.minutes_per_round || '-' }) }}</span>
              </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>{{ t('step2.estimatedRuntime', { minutes: Math.round(customMaxRounds * 0.6) }) }}</span>
                  </div>
                </div>
                ...
                <div class="range-wrapper">
                  ...
                  <div class="range-marks">
                    ...
                    >{{ t('step2.recommendedRounds') }}</span>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        {{ t('step2.estimatedRuntime', { minutes: Math.round(autoGeneratedRounds * 0.6) }) }}
                      </span>
                    </div>
                    <div class="auto-desc">
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            <div class="info-item">
              ...
              <span class="info-value">{{ t('step2.ageValue', { value: selectedProfile.age || '-' }) }}</span>
            </div>
            <div class="info-item">
              <span class="info-label">{{ t('step2.visibleGender') }}</span>
              <span class="info-value">{{ genderLabel(selectedProfile.gender) }}</span>
            </div>
            <div class="info-item">
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              <div class="dimension-card">
                <span class="dim-title">{{ t('step2.personaDimensions.eventJourney.title') }}</span>
                <span class="dim-desc">{{ t('step2.personaDimensions.eventJourney.desc') }}</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">{{ t('step2.personaDimensions.behaviorPattern.title') }}</span>
                <span class="dim-desc">{{ t('step2.personaDimensions.behaviorPattern.desc') }}</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">{{ t('step2.personaDimensions.memoryImprint.title') }}</span>
                <span class="dim-desc">{{ t('step2.personaDimensions.memoryImprint.desc') }}</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">{{ t('step2.personaDimensions.socialGraph.title') }}</span>
                <span class="dim-desc">{{ t('step2.personaDimensions.socialGraph.desc') }}</span>
              </div>
            </div>
...
import { formatPrepareProgressLog } from './simulationLogMessages'
import { getStep2RecoveryState } from './step2Recovery'
...
const step3RecoveryState = computed(() => getStep2RecoveryState({
...
const genderLabel = (gender) => {
  const labels = {
    male: t('step2.gender.male'),
    female: t('step2.gender.female'),
    other: t('step2.gender.other')
  }
...
const handleStartSimulation = () => {
  ...
  if (useCustomRounds.value) {
    ...
    addLog(t('step2.logs.startSimulationCustomRounds', { count: customMaxRounds.value }))
  } else {
    // 用户选择保持自动生成的轮数，不传递 max_rounds 参数
    addLog(t('step2.logs.startSimulationAutoRounds', { count: autoGeneratedRounds.value }))
  }
...
const openSavedStep3Run = () => {
  if (!step3RecoveryState.value?.route) {
    return
  }
...
const startPrepareSimulation = async () => {
  if (!props.simulationId) {
    addLog(t('step2.logs.missingSimulationId'))
  ...
  // 标记第一步完成，开始第二步
  phase.value = 1
  addLog(t('step2.logs.instanceCreated', { id: props.simulationId }))
  addLog(t('step2.logs.preparingEnvironment'))
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.already_prepared) {
        addLog(t('step2.logs.reusePreparedData'))
        await loadPreparedData()
        return
      }
      
      taskId.value = res.data.task_id
      addLog(t('step2.logs.prepareTaskStarted'))
      addLog(t('step2.logs.taskId', { id: res.data.task_id }))
      
      // 立即设置预期Agent总数（从prepare接口返回值获取）
      if (res.data.expected_entities_count) {
        expectedTotal.value = res.data.expected_entities_count
        addLog(t('step2.logs.entityCount', { count: res.data.expected_entities_count }))
        if (res.data.entity_types && res.data.entity_types.length > 0) {
          addLog(t('step2.logs.entityTypes', { types: res.data.entity_types.join(', ') }))
        }
      }
      
      addLog(t('step2.logs.startPolling'))
      // 开始轮询进度
      startPolling()
      // 开始实时获取 Profiles
      startProfilesPolling()
    } else {
      addLog(t('step2.logs.prepareFailed', { message: res.error || t('step2.unknownError') }))
      emit('update-status', 'error')
    }
  } catch (err) {
    addLog(t('step2.logs.prepareException', { message: err.message }))
    emit('update-status', 'error')
  }
}
    ...
    if (res.success && res.data) {
      ...
      // 解析阶段信息并输出详细日志
        ...
        if (logKey !== lastLoggedMessage && detail.item_description) {
          ...
          const progressLog = formatPrepareProgressLog(detail, t)
          if (progressLog) {
            addLog(progressLog)
          }
        }
      ...
      if (data.status === 'completed' || data.status === 'ready' || data.already_prepared) {
        addLog(t('step2.logs.prepareCompleted'))
        stopPolling()
        stopProfilesPolling()
        await loadPreparedData()
      } else if (data.status === 'failed') {
        addLog(t('step2.logs.prepareFailedMarked', { message: data.error || t('step2.unknownError') }))
        stopPolling()
        stopProfilesPolling()
      }
    }
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      if (currentCount > 0 && currentCount !== lastLoggedProfileCount) {
        ...
        if (currentCount === 1) {
          addLog(t('step2.logs.generatingProfiles'))
        }
        addLog(t('step2.logs.profileProgress', { current: currentCount, total, name: profileName, profession: latestProfile?.profession || t('step2.unknownProfession') }))
        
        // 如果全部生成完成
        if (expectedTotal.value && currentCount >= expectedTotal.value) {
          addLog(t('step2.logs.allProfilesCompleted', { count: currentCount }))
        }
      }
    }
  } catch (err) {
    ...
    if (res.success && res.data) {
      ...
      if (data.generation_stage && data.generation_stage !== lastLoggedConfigStage) {
        ...
        if (data.generation_stage === 'generating_profiles') {
          addLog(t('step2.logs.generatingProfileConfig'))
      ...
      if (data.config_generated && data.config) {
        ...
        addLog(t('step2.logs.configGenerated'))
        
        // 显示详细配置摘要
        if (data.summary) {
          addLog(t('step2.logs.summaryAgents', { count: data.summary.total_agents }))
          addLog(t('step2.logs.summaryHours', { hours: data.summary.simulation_hours }))
          addLog(t('step2.logs.summaryPosts', { count: data.summary.initial_posts_count }))
          addLog(t('step2.logs.summaryTopics', { count: data.summary.hot_topics_count }))
          addLog(t('step2.logs.summaryPlatforms', { twitter: data.summary.has_twitter_config ? '✓' : '✗', reddit: data.summary.has_reddit_config ? '✓' : '✗' }))
        }
        
        // 显示时间配置详情
        if (data.config.time_config) {
          const tc = data.config.time_config
          addLog(t('step2.logs.timeConfig', { minutes: tc.minutes_per_round, rounds: Math.floor((tc.total_simulation_hours * 60) / tc.minutes_per_round) }))
        }
        
        // 显示事件配置
        if (data.config.event_config?.narrative_direction) {
          const narrative = data.config.event_config.narrative_direction
          addLog(t('step2.logs.narrativeDirection', { narrative: narrative.length > 50 ? narrative.substring(0, 50) + '...' : narrative }))
        }
        
        stopConfigPolling()
        phase.value = 4
        addLog(t('step2.logs.environmentReady'))
...
const loadPreparedData = async () => {
  phase.value = 2
  addLog(t('step2.logs.loadingPreparedData'))

  // 最后获取一次 Profiles
  await fetchProfilesRealtime()
  addLog(t('step2.logs.loadedProfiles', { count: profiles.value.length }))
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.config_generated && res.data.config) {
        ...
        addLog(t('step2.logs.configLoaded'))
        
        // 显示详细配置摘要
        if (res.data.summary) {
          addLog(t('step2.logs.summaryAgents', { count: res.data.summary.total_agents }))
          addLog(t('step2.logs.summaryHours', { hours: res.data.summary.simulation_hours }))
          addLog(t('step2.logs.summaryPostsOnly', { count: res.data.summary.initial_posts_count }))
        }
        ...
        // 配置尚未生成，开始轮询
        addLog(t('step2.logs.configPolling'))
        startConfigPolling()
      }
    }
  } catch (err) {
    addLog(t('step2.logs.loadConfigFailed', { message: err.message }))
    emit('update-status', 'error')
  }
}
...
.step3-recovery-card {
  ...
  border-radius: 10px;
  background: linear-gradient(135deg, #FFF8ED 0%, #FFFCF6 100%);
}

            ...
            >
              ...
              <div class="section-body" v-show="!collapsedSections.has(idx)">
                ...
                <div v-else-if="currentSectionIndex === idx + 1" class="loading-state">
                  ...
                  <span class="loading-text">{{ t('step5.sectionGenerating', { title: section.title }) }}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                <div class="tools-card-name">{{ t('step5.reportAgentChatTitle') }}</div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">{{ t('step5.tools.insightForge.name') }}</div>
                    <div class="tool-desc">{{ t('step5.tools.insightForge.desc') }}</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">{{ t('step5.tools.panoramaSearch.name') }}</div>
                    <div class="tool-desc">{{ t('step5.tools.panoramaSearch.desc') }}</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">{{ t('step5.tools.quickSearch.name') }}</div>
                    <div class="tool-desc">{{ t('step5.tools.quickSearch.desc') }}</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">{{ t('step5.tools.interviewSubAgent.name') }}</div>
                    <div class="tool-desc">{{ t('step5.tools.interviewSubAgent.desc') }}</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? t('step5.emptyReportAgentChat') : t('step5.emptyAgentChat') }}
              </p>
            </div>
            <div 
              ...
              <div class="message-content">
                <div class="message-header">
                  <span class="sender-name">
                    {{ msg.role === 'user' ? t('step5.you') : (chatTarget === 'report_agent' ? t('step5.reportAgent') : (selectedAgent?.username || t('step5.agentFallback'))) }}
                  </span>
...
const sendToReportAgent = async (message) => {
  addLog(t('step5.logs.sentToReportAgent', { message: message.substring(0, 50) }))
  ...
  if (res.success && res.data) {
    ...
    addLog(t('step5.logs.reportAgentReplied'))
  } else {
...
const sendToAgent = async (message) => {
  ...
  if (chatHistory.value.length > 1) {
    const historyContext = chatHistory.value
      ...
      .slice(-6)
      .map(msg => `${msg.role === 'user' ? t('step5.historyQuestioner') : t('step5.historyYou')}：${msg.content}`)
      .join('\n')
    prompt = t('step5.historyPrompt', { history: historyContext, message })
  }
  ...
  if (res.success && res.data) {
    ...
    if (responseContent) {
      ...
      addLog(t('step5.logs.agentReplied', { name: selectedAgent.value.username }))
    } else {
...
const submitSurvey = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(t('step5.logs.receivedReplies', { count: surveyResults.value.length }))
    } else {
      throw new Error(res.error || t('step5.requestFailed'))
    }
  } catch (err) {
...
const loadReportData = async () => {
  ...
  try {
    addLog(t('step5.logs.loadingReport', { id: props.reportId }))
    ...
    addLog(t('step5.logs.loadReportFailed', { message: err.message }))
  }
}
...
const loadAgentLogs = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(t('step5.logs.reportLoaded'))
    }
  } catch (err) {
    addLog(t('step5.logs.loadReportLogsFailed', { message: err.message }))
  }
}

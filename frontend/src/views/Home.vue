    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              {{ t('home.desc1') }}<span class="highlight-bold">{{ t('home.desc2') }}</span>{{ t('home.desc3') }}<span class="highlight-orange">{{ t('home.desc4') }}</span>{{ t('home.desc5') }}<span class="highlight-code">{{ t('home.desc6') }}</span>{{ t('home.desc7') }}
            </p>
            <p class="slogan-text">

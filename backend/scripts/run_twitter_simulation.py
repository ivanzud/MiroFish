...
def _load_simulation_dependencies() -> None:
    ...
    global generate_twitter_agent_graph, oasis
...
class TwitterSimulationRunner:
    ...
    def _create_model(self):
        ...
        - LLM_API_KEY / OPENAI_API_KEY: API密钥
        - LLM_BASE_URL / OPENAI_BASE_URL / OPENAI_API_BASE_URL: API基础URL
        - LLM_MODEL_NAME / OPENAI_MODEL: 模型名称
        """
        # 优先从 .env 读取配置
...
async def main():
    parser = argparse.ArgumentParser(
        description=script_message("runner_title", SCRIPT_LOCALE, platform="Twitter")
    )
    parser.add_argument(
        '--config', 
        type=str, 

...
- State filter: `all`
- Captured: `2026-03-11T15:11:54.718886+00:00`
- Issues: `86` total (`open=37`, `closed=49`)
- Pull requests: `50` total (`open=36`, `closed=14`)
- Mirrored in `origin`: `50` of `50` PR refs
- Mirrored in `ivanzud/MiroFish`: `86` of `86` issues
...
- #123 [closed, mirror=#42] プリセット業界知識RAGの導入（方式3: ローカルファイル注入） (no labels)
